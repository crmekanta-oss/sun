...
export function CSVImportModal({ onClose, onImport, users, user, T }) {
  ...
  return (
    <div style={{ position:"fixed",inset:0,background:"rgba(0,0,0,0.4)",zIndex:9100,display:"flex",alignItems:"center",justifyContent:"center",padding:16,backdropFilter:"blur(2px)" }} onClick={onClose}>
      <div style={{ background:T.surface,borderRadius:12,width:"100%",maxWidth:640,boxShadow:T.shadowXl,animation:"fadeUp .2s ease",maxHeight:"90vh",display:"flex",flexDirection:"column" }} onClick={e=>e.stopPropagation()}>
