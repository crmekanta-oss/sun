  ...
  return (
    <>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit, minmax(140px, 1fr))", gap:10 }}>
        ...
        <KpiCard label="Won Deals"        value={M.won}     cmpValue={CM?.won}     icon={P.check}  color={T.won.dot}     bg={T.won.bg}       compareOn={compareOn} T={T} />
        ...
        <KpiCard label="Won Revenue"      value={M.wonRev}  cmpValue={CM?.wonRev}  icon={P.layers} color="#5B3BE8"       bg={T.brandSubtle}  compareOn={compareOn} T={T} />
        <KpiCard label="Avg Deal Size"    value={M.avgDeal} cmpValue={CM?.avgDeal} icon={P.tag}    color={T.pending.dot} bg={T.pending.bg}   compareOn={compareOn} T={T} />
        ...
        <KpiCard label="Today Follow-ups" value={M.todayF}  cmpValue={CM?.todayF}  icon={P.bell}   color={T.pending.dot} bg={T.pending.bg}   compareOn={compareOn} T={T} />
      </div>
