        ...
        return (
          <div key={f.id} onClick={() => onView(f)}
            style={{
              ...
              background: over ? `${T.lost.dot}05` : i % 2 === 0 ? T.surface : T.surfaceEl,
              cursor: "pointer", transition: "background .12s",
              animation: `fadeUp .2s ease ${Math.min(i, 6) * 0.04}s both`,
            }}
            onMouseEnter={e => e.currentTarget.style.background = T.brandSubtle}
            onMouseLeave={e => e.currentTarget.style.background = over ? `${T.lost.dot}05` : i % 2 === 0 ? T.surface : T.surfaceEl}>
