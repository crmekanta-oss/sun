...
export function NotificationCenter({ funnels, user, onView, onClose, T }) {
  ...
  return (
    <div style={{ position: "fixed", top: 48, right: 16, width: 360, maxHeight: 480, background: T.surface, border: `1px solid ${T.line}`, borderRadius: 12, boxShadow: T.shadowXl, zIndex: 4000, display: "flex", flexDirection: "column", animation: "fadeUp .18s ease" }}>
