      ...
      <div style={{ display: "grid", gridTemplateColumns: "360px 1fr", gap: 16 }} className="ek-team-grid">
        ...
        <div style={{ background: T.surface, border: `1px solid ${T.line}`, borderRadius: 10, padding: 22, boxShadow: T.shadowSm, height: "fit-content" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <FInput label="Full name" value={form.name} onChange={e=>sf("name",e.target.value)} placeholder="e.g. Priya Sharma" T={T} required />
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
              <FInput label="Username" value={form.username} onChange={e=>sf("username",e.target.value)} placeholder="priya" T={T} required />
              <div>
            ...
            <FSelect label="Role" value={form.role} onChange={e=>sf("role",e.target.value)} options={ROLES} T={T} />
                  ...
                  {isEditing ? (
                    ...
                    <div style={{ padding: "16px 20px", background: T.brandSubtle, borderLeft: "3px solid #5B3BE8" }}>
                      ...
                      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 10, marginBottom: 10 }}>
                        <FInput label="Full name" value={editForm.name} onChange={e=>se("name",e.target.value)} placeholder="Full name" T={T} />
                        <FInput label="Username" value={editForm.username} onChange={e=>se("username",e.target.value)} placeholder="username" T={T} />
                        <div>
                        ...
                        <FSelect label="Role" value={editForm.role} onChange={e=>se("role",e.target.value)} options={ROLES} T={T} />
                      </div>
