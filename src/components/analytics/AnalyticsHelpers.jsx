...
export function KpiCard({ label, value, cmpValue, rawValue, rawCmpValue, icon, color, bg, compareOn, T }) {
  ...
  return (
    <div style={{ background:T.surface, border:`1px solid ${T.line}`, borderRadius:14, padding:"20px", boxShadow:T.shadowSm, position:"relative", overflow:"hidden" }}>
      <div style={{ position:"absolute", top:0, right:0, width:80, height:80, borderRadius:"0 0 0 80px", background:bg||T.brandSubtle, opacity:0.4 }}/>
      ...
      <div style={{ position:"absolute", top:14, right:14, opacity:0.25 }}>
        {isEmoji ? (
          ...
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" style={{ display:"block" }}>
            <path d={icon} stroke={color||T.brand} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        )}
      </div>
